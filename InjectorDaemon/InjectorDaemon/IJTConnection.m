...
- (void) reachabilityChanged:(NSNotification *)note {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        NSString *externalIPAddress = [IJTConnection externalIPAddress];
        ...
        [connectionDict setValue:externalIPAddress forKey:@"ExternalIpAddress"];
...
+ (NSString *)externalIPAddress {
    ...
    if (!error) {
        ...
        while ([theScanner isAtEnd] == NO) {
            ...
            if(ipItemsArray.count > an_Integer + 1)
        ...
        // Return External IP
        return externalIP ? externalIP : @"0.0.0.0";
    } else {
        // Error, no address found
        return @"0.0.0.0";
    }
