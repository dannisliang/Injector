...
+ (NSString *) formatTimestamp: (struct timeval)tv decimalPoint: (int)decimalPoint {
    ...
    return [NSString stringWithFormat:@"%s%0*.*f",
            tmbuf, decimalPoint + 3, decimalPoint,
...
+ (NSString *)formatTimestampWithWholeInfo:(struct timeval)tv decimalPoint:(int)decimalPoint {
    ...
    NSString *time = [IJTFormatString formatTimestamp:tv decimalPoint:decimalPoint];
