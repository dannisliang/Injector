...
- (void)getFacebookStatusThread {
    NSString *facebook = [IJTHTTP retrieveFrom:@"GetConnectionStatus.php"
...
- (void)getGoogleStatusThread {
    ...
    NSString *google = [IJTHTTP retrieveFrom:@"GetConnectionStatus.php"
...
- (void)connectToSocialThread: (id)object {
    ...
    if(connect) { //
        ...
        NSString *result = [IJTHTTP retrieveFrom:@"DisconnectUser.php"
