...
@property (nonatomic, strong) NSArray *systemImageArray;
@property (nonatomic, strong) NSArray *networkImageArray;
...
- (void)viewDidLoad {
    ...
    self.systemImageArray = [IJTBaseViewController getSystemImageNameArray];
    self.networkImageArray = [IJTBaseViewController getNetworkImageNameArray];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(indexPath.section == 0) {
        imageName = self.systemImageArray[indexPath.row];
        name = self.systemToolArray[indexPath.row];
    }
    else if(indexPath.section == 1) {
        imageName = self.networkImageArray[indexPath.row];
