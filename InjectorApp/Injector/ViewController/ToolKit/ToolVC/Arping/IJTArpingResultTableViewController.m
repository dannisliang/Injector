    ...
    for(_currentIndex = 0 ; _currentIndex < self.amount || self.infinity ; _currentIndex++) {
        ...
        if(ret == -1) {
            ...
            [IJTDispatch dispatch_main:^{ //timeout
                ...
                [dict setValue:[IJTFormatString formatTimestamp:timestamp decimalPoint:3] forKey:@"Timestamp"];
...
ARPING_CALLBACK_METHOD {
    [IJTDispatch dispatch_main:^{
        ...
        [dict setValue:[IJTFormatString formatTimestamp:rt decimalPoint:3] forKey:@"Timestamp"];
