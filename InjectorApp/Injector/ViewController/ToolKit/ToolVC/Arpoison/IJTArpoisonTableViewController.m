...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    if(self.targetTypeSegmentedControl.selectedSegmentIndex == 0 ||
       self.targetTypeSegmentedControl.selectedSegmentIndex == 3) {
        if(section == 0 || section == 1 || section == 3 || section == 4 || section == 5 || section == 6)
            return 1;
        else if(section == 2)
            return 3;
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if((self.targetTypeSegmentedControl.selectedSegmentIndex == 0 && indexPath.section == 3 && indexPath.row == 0) ||
       (self.targetTypeSegmentedControl.selectedSegmentIndex == 1 && indexPath.section == 2 && indexPath.row == 0) ||
       (self.targetTypeSegmentedControl.selectedSegmentIndex == 2 && indexPath.section == 3 && indexPath.row == 0) ||
       (self.targetTypeSegmentedControl.selectedSegmentIndex == 3 && indexPath.section == 3 && indexPath.row == 0)) {
        GET_ARG_CELL;
