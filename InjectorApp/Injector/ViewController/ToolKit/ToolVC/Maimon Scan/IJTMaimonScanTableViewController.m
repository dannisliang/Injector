//
//  IJTMaimonScanTableViewController.m
//  Injector
//
...
#import "IJTMaimonScanTableViewController.h"
#import "IJTMaimonScanResultTableViewController.h"
@interface IJTMaimonScanTableViewController ()
...
@implementation IJTMaimonScanTableViewController
...
- (void)viewDidLoad {
    ...
    [self.actionButton addTarget:self action:@selector(gotoACKScanVC) forControlEvents:UIControlEventTouchUpInside];
...
- (void) gotoACKScanVC {
    ...
    IJTMaimonScanResultTableViewController *vc = [self.storyboard instantiateViewControllerWithIdentifier:@"MaimonScanResultVC"];
