...
- (void)misunderstanding {
    ...
    [alert addButton:@"Yes" actionBlock:^{
        ...
        [IJTDispatch dispatch_main_after:DISPATCH_DELAY_TIME block:^{
            ...
            NSString *result = [IJTHTTP retrieveFrom:@"ReceiveMisunderstandingHost.php"
                                                post:post
                                             timeout:5];
...
- (void)retrieveIpRelatedApplication: (UIView *)graphView {
    _colors = @[[IJTColor lighter:IJTFlowColor times:2],
                [IJTColor lighter:IJTSnifferColor times:1],
                [IJTColor lighter:IJTLANColor times:1],
                [IJTColor lighter:IJTToolsColor times:1],
                [IJTColor lighter:IJTFirewallColor times:1],
                [IJTColor lighter:IJTSupportColor times:1]];
    
    NSDictionary *appdict = nil;
    
    for(int i = 0 ; i < 2 ;i++) {
        NSString *jsonstring = [IJTHTTP retrieveFrom:@"RetrieveIpRelatedApplication.php"
