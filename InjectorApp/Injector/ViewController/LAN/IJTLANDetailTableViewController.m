...
@property (nonatomic, strong) NSArray *toolImageArray;
...
- (void)viewDidLoad {
    ...
    self.toolImageArray = [IJTBaseViewController getLANSupportToolImageNameArray];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if(indexPath.section == 0) {
        ...
        [IJTFormatUILabel text:_toolArray[indexPath.row]
                         label:cell.nameLabel
                          font:[UIFont systemFontOfSize:17]];
        
        cell.iconImageView.image = [UIImage imageNamed:_toolImageArray[indexPath.row]];
